...
const RoleInfoheader = ({
  ...
  return (
    <div className='bg-white relative pt-[72px]'> {/* Push content below navbar */}
      <div className="container mx-auto px-6 md:px-0">
        ...
        <div className='w-[40vw] md:w-[30vw] h-[200px] items-center justify-center bg-white overflow-hidden absolute top-0 right-0'>
